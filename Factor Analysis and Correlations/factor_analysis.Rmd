...
# Note: subcomponent_safe_access_to_public_spaces is exactly the same as component_vibrant_communities_model. subcomponent_cultural_identity_and_connection_model is exactly the same as component_cultural_identity_model.
```
