...
# subheading_theme <- element_text(hjust = 0, size = 9, colour = "black", family = font_axis_label, face = "bold", margin = margin(t = 10, l = 0))
    ...
    caption_text <- "\nData Source: Catalyst California's calculations of Bold Vision Youth Thriving Survey, \n2024. For more information on the methodology, please refer to the 2025 Bold Vision \nYouth Thriving report."
...
title_text <- "When youth are told hurtful or offensive jokes/comments about their race, they are more likely to feel worthless"
...
title_text <- "When youth lack access to quality health services, they are likely to feel worthless"
string_question_var2 <- "During the past 30 days, \nI felt worthless..."
