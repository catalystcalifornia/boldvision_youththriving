...
```{r, include=FALSE, echo=FALSE}
test_component_models <- c(component_caring_families_and_relationships_model)
...
```{r}
# Apply function run_cfa to the models
# test_component_results <- lapply(test_component_models, run_cfa)
