...
get_revised_asian_response <- function(response) {
  ...
  if (grepl("Filipino", response, ignore.case = TRUE))
  {ethnicities <- c(ethnicities, "bd", "isSoutheastAsian")}
  
  if (grepl("Southwest", response, ignore.case = TRUE))
  ...
  if (grepl("Pakistani|Bangladesh|Bengali|Sri Lankan", response, ignore.case = TRUE))
