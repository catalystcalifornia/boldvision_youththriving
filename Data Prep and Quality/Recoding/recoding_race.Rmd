...
final_df <- svy_data_final %>%
  select(response_id,
         nh_race, acs_race, 
         race_aian, race_indigenous, race_aian_indigenous, 
         race_black, race_latinx, race_asian, race_nhpi, 
         race_swana, race_white, race_dwta, race_other, 
         detailed_race, detailed_asian, detailed_nhpi, 
         isSouthAsian,isSoutheastAsian)
...
column_comments <- c(
  ...
  "0/1 flag respondents that selected or were recoded as American Indian and Alaska Native",
  "0/1 flag respondents that selected or were recoded as Indigenous from Mexico, Central America, or South America", 
  "0/1 flag respondents that selected or were recoded as American Indian and Alaska Native OR Indigenous from Mexico, Central America, or South America",
  
  "0/1 flag respondents that selected or were recoded as Black or African American",
  "0/1 flag respondents that selected or were recoded as Latinx/Latino/a/Hispanic",
  "0/1 flag respondents that selected or were recoded as Asian or Asian American",
  "0/1 flag respondents that selected or were recoded as Native Hawaiian and Pacific Islander",
  
  "0/1 flag respondents that selected or were recoded as South West Asian and North African",
  "0/1 flag respondents that selected or were recoded as White",
  "0/1 flag respondents that selected or were recoded as Do Not Wish to Answer",
  "0/1 flag respondents that selected or were recoded as Other Race",
