...
exp_racism <- dbGetQuery(con, "SELECT * FROM youth_thriving.tot_freq_racial_justice
...
vibrant <- dbGetQuery(con, "SELECT * FROM youth_thriving.tot_freq_vibrant_community")
