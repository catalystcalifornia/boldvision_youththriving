...
```{r}
# Function parameters: var1 = Caring families/dl, var2 = Psych distress/cy
crosstab_caring_psych <- cross_tab_df(raw_svy_data, "dl", "cy",  svy_dd)
push_crosstab_table(crosstab_caring_psych, "crosstab_caring_psych")
```

# Crosstab on Sparks/hope for future
```{r}
# Function parameters: var1 = Sparks/q10, var2 = Hope for the future/co
crosstab_sparks_hope <- cross_tab_df(raw_svy_data, "q10", "co",  svy_dd)
