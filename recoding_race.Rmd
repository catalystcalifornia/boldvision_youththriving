...
svy_data_final <- svy_data_final %>%
  ...
  mutate(
    ...
    race_sum = sum(c(race_aian_indigenous, race_black, race_asian, race_nhpi, race_swana, race_white)),
    nh_race = case_when(
...
final_df<-svy_data_final%>%
  select(response_id, nh_race, race_aian_indigenous, race_aian, race_black, race_indigenous, race_latinx, 
