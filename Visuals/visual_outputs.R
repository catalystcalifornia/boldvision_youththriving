...
fx_single_barchart(question_number_i = '18', sub_question_i = 'Contact with the police', #these are the inputs, i stands for insert/input of the variable of interest we want to look at
                   response_label_1 = 'Sometimes', response_label_2 = 'Most of the time', response_label_3 = 'All of the time', #insert the responses we want to capture data for, up to 3
                   title_text = 'Contact with police is interfering with NHPI and Black youth at a rate higher than most groups', 
                   x_axis_text = 'Rate of youth reporting contact with police is getting in way of living their best life at least sometimes' #insert text on graph that is customized
)  
...
#RAN BUT HAVING ISSUES 
fx_single_barchart_freq(domain_pgname = 'vibrant_community', #name of domain as it is in the pgadmine table// for example, "strong_minds"
                        variable_i = 'dt', #these are the inputs, i stands for insert/input of the variable of interest we want to look at
                        likert_type_i = yes_scale ,
                        title_text = 'Over half of youth report the importance of their cultural identity to feeling good about who they are', x_axis_text = '' #insert text on graph that is customized
)
